package com.nisum.onboarding.report.util;
...
public class ReportTemplates {
	...
	static {
		...
		boldCenteredStyle = stl.style(boldStyle).setAlignment(HorizontalAlignment.CENTER,
		...
		StyleBuilder crosstabGroupTotalStyle = stl.style(columnTitleStyle).setBackgroundColor(
				new Color(170, 170, 170));
		StyleBuilder crosstabGrandTotalStyle = stl.style(columnTitleStyle).setBackgroundColor(
		...
		dynamicReportsComponent = cmp.horizontalList(
				cmp.image(ReportTemplates.class.getResource("images/dynamicreports.png"))
						.setFixedDimension(60, 60),
				cmp.verticalList(cmp.text("DynamicReports").setStyle(bold22CenteredStyle)
						.setHorizontalAlignment(HorizontalAlignment.LEFT),
						cmp.text("http://www.dynamicreports.org").setStyle(italicStyle)
	...
	public static ComponentBuilder<?, ?> createTitleComponent(String label) {
		return cmp
				...
				.add(dynamicReportsComponent,
						cmp.text(label).setStyle(bold18CenteredStyle)
								.setHorizontalAlignment(HorizontalAlignment.RIGHT)).newRow()
